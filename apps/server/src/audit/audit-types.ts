...
export const AUDIT_EVENT_TYPES = [
  ...
  "workspace_checkpoint_invalid",
  "workspace_checkpoint_reconciled",
...
export const AUDIT_EVENT_CATEGORY: Record<AuditEventType, AuditCategory> = {
  ...
  workspace_checkpoint_created: "workspace",
  workspace_checkpoint_failed: "workspace",
  workspace_checkpoint_invalid: "workspace",
  workspace_checkpoint_reconciled: "workspace",
  workspace_checkpoint_restore_started: "workspace",
  workspace_checkpoint_restored: "workspace",
  workspace_checkpoint_restore_failed: "workspace",
  workspace_recovery_required: "workspace",
  workspace_recovery_resumed: "workspace",
