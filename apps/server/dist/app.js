...
export async function createApp(config, service) {
    const app = Fastify({
        logger: {
    ...
    app.addHook("onRequest", async (request, reply) => {
        ...
        const valid = candidateBuffer.length === expectedBuffer.length &&
    ...
    app.setErrorHandler((error, request, reply) => {
        ...
        const frameworkStatus = typeof error.statusCode === "number"
            ? error.statusCode
            : null;
